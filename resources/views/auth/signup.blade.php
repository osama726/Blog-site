    ...
    <div class="min-h-screen flex items-center justify-center">
        ...
        <div class="w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-lg p-8">
            ...
            <form method="POST" action="{{ route('signup.store') }}">
                ...
                <button
                    class="w-full bg-indigo-900 text-white py-2 rounded-md hover:bg-indigo-700 transition"
                >
                    Sign up
                </button>
            ...
            <p class="text-sm text-gray-500 text-center mt-6">
                ...
                <a href="{{ route('login') }}" class="text-indigo-700 font-medium hover:underline">
                    Login
                </a>
            </p>
